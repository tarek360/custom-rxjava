 ...
 * {@link custom.reactivex.Flowable}, {@link custom.reactivex.Observable}, {@link custom.reactivex.Single}
 * or {@link custom.reactivex.Completable} class which then allow consumers to subscribe to them
 * and receive events.</p>
 * <p>Usage examples can be found on the {@link custom.reactivex.Flowable}/{@link custom.reactivex.Observable} and {@link org.reactivestreams.Subscriber} classes.</p>
 */
